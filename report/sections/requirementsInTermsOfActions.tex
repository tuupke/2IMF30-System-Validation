...
\end{itemize}
 ...
 \begin{itemize}
 \item After any \action{detectInputWafer}{}, there must be a chain of move actions connecting $RI$ to $P$, followed by a $beginProject()$ and $endProject()$ without intervening move actions with $P$, followed by a chain of move actions from $P$ to $RO$.\\
 Unless\\
