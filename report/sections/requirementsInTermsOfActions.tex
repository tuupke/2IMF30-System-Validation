...
\begin{itemize}
	...
	\item between any \action{move}{$s, I$} and its most recent preceding \action{closeInside}{$s$}, there must be a \action{openInside}{$s$}.
	\item between any \action{move}{$O, s$} and its most recent preceding \action{closeInside}{$s$}, there must be a \action{openInside}{$s$}.
	\item between any \action{move}{$s, RO$} and its most recent preceding \action{closeOutside}{$s$}, there must be a \action{openOutside}{$s$}.
\end{itemize}
