...
For any place $a$ in the system: before any \action{move}{$a, RI$}, a \action{detectWafer}{$a, unprojected$} must have been executed and in between, no \action{move}{$a, b$} has been executed for any $b$.
