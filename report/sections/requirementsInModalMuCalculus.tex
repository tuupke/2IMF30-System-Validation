...
&  \tab\tab  \wedge [endProject]X(position, \\
& \tab\tab\tab\tab false, \\
& \tab\tab\tab\tab  projected \vee (projecting \wedge position \approx P), \\
& \tab\tab\tab\tab  stuck, \\
& \tab\tab\tab\tab  brokenDoors \\
& \tab\tab\tab ) \\
...
&)		
 ...
 &\tab \wedge [openDoor(d,s).\overline{closeDoor(d,s)}*.vacuum(s)]false \\
 &)
 \end{align*}
